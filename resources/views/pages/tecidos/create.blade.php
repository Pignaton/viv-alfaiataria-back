...
@section('content_header')
    <div class="col-sm-6">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Adicionar Tecido</li>
        </ol>
    </div>
@stop
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Cadastrar Novo Tecido</h3>
        <div class="card-tools">
            <a href="{{ route('admin.tecidos.index') }}" class="btn btn-default btn-sm">
    ...
    <div class="card-body">
        <form action="{{ route('admin.tecidos.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="composicao" id="composicao"
                               ...
                               value="{{ old('composicao') }}" required maxlength="50">
                        @error('composicao')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="padrao" id="padrao"
                               ...
                               value="{{ old('padrao') }}" required maxlength="100">
                        @error('padrao')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <select name="suavidade" id="suavidade"
                            ...
                            <option value="Macio" {{ old('suavidade') == 'Macio' ? 'selected' : '' }}>Macio</option>
                            <option value="Médio" {{ old('suavidade') == 'Médio' ? 'selected' : '' }}>Médio</option>
                            <option value="Áspero" {{ old('suavidade') == 'Áspero' ? 'selected' : '' }}>Áspero</option>
                            <option value="Liso" {{ old('suavidade') == 'Liso' ? 'selected' : '' }}>Liso</option>
                            <option value="Texturizado" {{ old('suavidade') == 'Texturizado' ? 'selected' : '' }}>
                                Texturizado
                            </option>
                        </select>
                        @error('suavidade')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tecelagem" id="tecelagem"
                               ...
                               value="{{ old('tecelagem') }}" required maxlength="50">
                        @error('tecelagem')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="fio" id="fio"
                               ...
                               value="{{ old('fio') }}" required maxlength="10">
                        @error('fio')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="origem" id="origem"
                               ...
                               value="{{ old('origem') }}" required maxlength="50">
                        @error('origem')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fabricante" id="fabricante"
                               ...
                               value="{{ old('fabricante') }}" maxlength="100">
                        @error('fabricante')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="peso" id="peso"
                               ...
                               value="{{ old('peso') }}" required maxlength="50">
                        @error('peso')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        <label for="imagem">Imagem do Tecido</label>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Cadastrar Tecido
                </button>
            </div>
        </form>
    </div>
